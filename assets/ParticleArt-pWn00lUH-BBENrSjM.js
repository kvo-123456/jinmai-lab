import{C as i,c as n}from"./index-DvRCDgMZ.js";function c(){const t=i.useRef(null);return i.useEffect(()=>{t.current&&(t.current.style.position="relative",t.current.style.width="100%",t.current.style.height="100vh",t.current.style.backgroundColor="#050505",t.current.style.margin="0",t.current.style.overflow="hidden",t.current.style.fontFamily="Segoe UI, sans-serif",t.current.innerHTML=`
        <!-- 加载遮罩层 -->
      ...
      `);const l=()=>{const e=document.createElement("link");e.href="https://cdn.tailwindcss.com",e.rel="stylesheet",document.head.appendChild(e);const r=document.createElement("link");r.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css",r.rel="stylesheet",document.head.appendChild(r);const s=document.createElement("style");s.textContent=`
        /* 摄像头预览窗口样式 */
        #camera-preview {
      ...
      `,document.head.appendChild(s)},a=e=>new Promise((r,s)=>{const o=document.createElement("script");o.src=e,o.crossOrigin="anonymous",o.onload=r,o.onerror=s,document.head.appendChild(o)});return(async()=>{try{l(),await a("https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js"),await Promise.all([a("https://cdn.jsdelivr.net/npm/@mediapipe/camera_utils/camera_utils.js"),a("https://cdn.jsdelivr.net/npm/@mediapipe/control_utils/control_utils.js"),a("https://cdn.jsdelivr.net/npm/@mediapipe/drawing_utils/drawing_utils.js"),a("https://cdn.jsdelivr.net/npm/@mediapipe/hands/hands.js")]),await a("/particle-system.js")}catch(e){console.error("Failed to load libraries:",e);const r=document.getElementById("loading-screen");r&&(r.innerHTML=`
          ...
          `)}})(),()=>{document.querySelectorAll("link").forEach(e=>{(e.href.includes("tailwindcss.com")||e.href.includes("font-awesome"))&&e.remove()}),document.querySelectorAll("style").forEach(e=>{e.textContent&&e.textContent.includes("摄像头预览窗口样式")&&e.remove()})}},[]),n.jsx("div",{ref:t,className:"w-full h-screen"})}export{c as default};
